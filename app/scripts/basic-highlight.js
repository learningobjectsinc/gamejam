    ...
    this.$rules = { start: 
       [ { caseInsensitive: true,
         ...
         { caseInsensitive: true,
           ...
           regex: '(?:\\b(((END(\\s)?)?(FUNCTION|IF|SELECT|SUB))|(GO(SUB|(\\s)?TO))|(CASE|DEF FN|ELSE|END DEF|EXIT SUB|FOR|NEXT|ON|ON ERROR GOTO|ON KEY|RETURN|SELECT CASE|THEN|WEND|WHILE))\\b)',
            },
